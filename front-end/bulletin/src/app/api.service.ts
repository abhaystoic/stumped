...
export class ApiService {
  ...
  public getSavedNewsArticles(
    ...
    return this.httpClient.post<any>(
      't/user/get-saved-news-articles', body, {headers}).pipe(
        catchError(err => {
          console.log(err);
  ...
  public getSavedNewsAndSentiments(
    ...
    return this.httpClient.post<any>(
      't/user/get-saved-news-and-sentiments', body, {headers}).pipe(
        catchError(err => {
          console.log(err);
          return throwError(
  ...
  public getSearchResults(query) {
    ...
    return this.httpClient.post<any>(
      'httpsearch-news', body, {headers}).pipe(
        catchError(err => {
          console.log(err);
  ...
  public saveNews(
    ...
    return this.httpClient.post<any>(
      't/user/save-news', body, {headers}).pipe(
        catchError(err => {
          console.log(err);
  ...
  public saveSentiment(
    ...
    return this.httpClient.post<any>(
      't/user/save-sentiments', body, {headers}).pipe(
        catchError(err => {
          console.log(err);
          return throwError('Failed to save news for the user.');
        }));
  ...
  public unSaveNews(
    ...
    return this.httpClient.post<any>(
      't/user/unsave-news', body, {headers}).pipe(
        catchError(err => {
          console.log(err);
  ...
  public saveFeedback(feedback) {
    ...
    return this.httpClient.post<any>(
      't/user/save-feedback', feedback, {headers}).pipe(
        catchError(err => {
          console.log(err);
  ...
  public saveUser(user) {
    ...
    return this.httpClient.post<any>(
      't/user/save-user', user, {headers}).pipe(
        catchError(err => {
          console.log(err);
